      ...
      <div class="flex flex-col md:flex-row justify-between items-start mb-8">
        <div class="mb-6 md:mb-0 max-w-xs">
          ...
          <p class="text-gray-600 dark:text-gray-400 mb-4">
            Профессиональный инструмент для сокращения URL, создания QR-кодов и
            отслеживания статистики переходов по вашим ссылкам.
          </p>
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-8">
          <div>
            <h3
              class="text-sm font-semibold text-gray-800 dark:text-gray-200 uppercase tracking-wider mb-4"
            >
              Функции
            </h3>
            <ul class="space-y-2">
